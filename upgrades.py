...
upgrade_list.append(Upgrade("Explosions", [f"+{int(EXPLODING_UPGRADE_CHANCE * 100)}% chance to", "Fire an explosive", "shot that deals", "Double damage !"], 112, 0, False, False, .7))
upgrade_list.append(Upgrade("Piercing", [f"+{int(PIERCING_UPGRADE_CHANCE * 100)}% chance to", "Fire an piercing", "shot that goes", "through asteroids"], 128, 0, False, False, .4))
...
# Instant Upgrades
upgrade_list.append(Upgrade("Bomb", ["Gives you a bomb", "That can clear all", "asteroids. Activate", "by pressing B."], 96, 0, False, True, 1.5))
